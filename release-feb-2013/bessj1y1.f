C  This routine was taken from NETLIB (www.netlib.org)
C
...
C   subprograms,  BESSJ1  and  BESSY1,  and one subroutine-type
...
C
C     BESSJ1(ARG)     |ARG| .LE. XMAX       J1(ARG)          0
C     BESSY1(ARG)   0 .LT. ARG .LE. XMAX    Y1(ARG)          1
C
...
C   FUNPACK program BESSJ1(X), but cannot match that version for
