...
!
	...
	!
		...
		if (this%lastsubgroup == n) &
			this%subgroup => reallocateGroupStreamAccess(this%subgroup,n + this%maxsubgroup/10 + 1) !"+1" for case maxsubgroup <= 1
...
!
	...
	if (this%maxdset == -1) then
		...
		if (this%lastdset == n) &
			this%dataset => reallocateDatasetStreamAccess(this%dataset,n + this%maxdset/10 + 1) !"+1" for case maxdset == 1
