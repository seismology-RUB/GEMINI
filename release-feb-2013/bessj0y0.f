C---------------------------------------------------------------------
C  This routine was taken from NETLIB (ww.netlib.org)
C
...
C   subprograms,  BESSJ0  and  BESSY0,  and one subroutine-type
...
C
C     BESSJ0(ARG)     |ARG| .LE. XMAX       J0(ARG)          0
C     BESSY0(ARG)   0 .LT. ARG .LE. XMAX    Y0(ARG)          1
C
...
C   FUNPACK program BESSJ0(X), but cannot match that version for
