...
c
	define(m4_splco,ifelse(m4_elcon_type,`double complex',`zsplco($*)',`dsplco($1,$2,$3,$4,$5,$6)'))
	define(m4_ze30,ifelse(m4_elcon_type,`double complex',`dcmplx(1.d30,1.d30)',`1.d30'))
c---------------------------------------------------------------
	subroutine earthmodel_spline
	include 'earthmodel.h'
	include 'layer.h'
	integer nl,j1,j2,n
	double precision y(nkk),y2(nkk)
	m4_elcon_type ze30
c
...
c
		call dsplco(earthmodel_rk(j1),earthmodel_ro(j1),n,1.d30,1.d30,earthmodel_ro2(j1))
		call dsplco(earthmodel_rk(j1),earthmodel_qk(j1),n,1.d30,1.d30,earthmodel_qk2(j1))
		call dsplco(earthmodel_rk(j1),earthmodel_qm(j1),n,1.d30,1.d30,earthmodel_qm2(j1))
		call m4_splco(earthmodel_rk(j1),earthmodel_zkap(j1),n,ze30,ze30,earthmodel_zkap2(j1),y,y2)
		call m4_splco(earthmodel_rk(j1),earthmodel_zmue(j1),n,ze30,ze30,earthmodel_zmue2(j1),y,y2)
		call m4_splco(earthmodel_rk(j1),earthmodel_za(j1),n,ze30,ze30,earthmodel_za2(j1),y,y2)
		call m4_splco(earthmodel_rk(j1),earthmodel_zc(j1),n,ze30,ze30,earthmodel_zc2(j1),y,y2)
		call m4_splco(earthmodel_rk(j1),earthmodel_zf(j1),n,ze30,ze30,earthmodel_zf2(j1),y,y2)
		call m4_splco(earthmodel_rk(j1),earthmodel_zl(j1),n,ze30,ze30,earthmodel_zl2(j1),y,y2)
		call m4_splco(earthmodel_rk(j1),earthmodel_zn(j1),n,ze30,ze30,earthmodel_zn2(j1),y,y2)
	enddo
	return
	end
c----------------------------------------------------------------
